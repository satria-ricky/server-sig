...
<!-- body -->
	...
	<div class="container-fluid" id="data_tempat_ibadah">
          ...
          <h4 class="ml-2 mt-2 font-weight-bold ml-5"> Daftar Tempat Ibadah</h4>
          <div class="card shadow mb-4 mr-5 ml-5">
            <div class="card-header py-3">
              ...
              <div class="btn-group">
                ...
                <select class="custom-select ml-2 mr-2" id="kabupaten" name="scrollkab" required="">
...
<!-- end of body -->
	...
	<div  style="margin-top: 100px;"></div>
      ...
      <div class="container-fluid" id="peta_tempat_ibadah">
          ...
          <!-- DataTales Example -->
          <h4 class="ml-2 mt-2 font-weight-bold ml-5"> Peta Tempat Ibadah</h4>
